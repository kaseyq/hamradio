...
class RotatorConfig(JsonSerializable):
    ...
    def __init__(self) :
        ...
        self.Memories = [
            ...
            {"Identifier": "d", "Command": "memory_d", "Degrees": 120},
            {"Identifier": "e", "Command": "memory_f", "Degrees": 150},
            {"Identifier": "f", "Command": "memory_g", "Degrees": 180},
            {"Identifier": "g", "Command": "memory_h", "Degrees": 210},
            {"Identifier": "h", "Command": "memory_i", "Degrees": 240},
            {"Identifier": "i", "Command": "memory_j", "Degrees": 280},
